...
def remove_grey_boxes(image_path, output_path, window_size=10, buffer_size=10):
    # Open the image
...
def remove_grey_boxes_with_scale(image_path, output_path, window_size=15, buffer_size=10, scale_factor=0.9):
    # Open the image
    img = Image.open(image_path)
